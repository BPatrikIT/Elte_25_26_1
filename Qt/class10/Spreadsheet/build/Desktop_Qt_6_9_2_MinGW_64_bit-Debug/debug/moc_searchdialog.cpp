...
template <> constexpr inline auto SearchDialog::qt_create_metaobjectdata<qt_meta_tag_ZN12SearchDialogE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'searchBackward'
        QtMocHelpers::SignalData<void(const QString, Qt::CaseSensitivity)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 2 }, { 0x80000000 | 3, 2 },
        }}),
        // Slot 'okClicked'
...
void SearchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SearchDialog::*)(const QString , Qt::CaseSensitivity )>(_a, &SearchDialog::searchForward, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SearchDialog::*)(const QString , Qt::CaseSensitivity )>(_a, &SearchDialog::searchBackward, 1))
            return;
    }
}
...
// SIGNAL 0
void SearchDialog::searchForward(const QString _t1, Qt::CaseSensitivity _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1, _t2);
}

// SIGNAL 1
void SearchDialog::searchBackward(const QString _t1, Qt::CaseSensitivity _t2)
{
