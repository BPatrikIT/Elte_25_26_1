...
namespace GyorsHir.ViewModel
{
    public class NewsItemViewModel : BindingSource
    {
        ...
        public bool IsShareable => !string.IsNullOrWhiteSpace(Title) && (!string.IsNullOrWhiteSpace(Description) || Link != null);
        ...
        public NewsItemViewModel(Model.RSS.RSSItem rssItem, DelegateCommand selectCommand, DelegateCommand shareCommand)
        {
            Title = rssItem.Title;
            Link = rssItem.Link;
